  ...
  <MainContainer>
   <Container>
    ...
    <Share css={css` @media ${device.mobile}{left:0px;top:70px;width:100%;}`}>
        ...
        <AdsContainer css={css`@media ${device.mobile}{height:auto;}`}>
       ...
       <ContentContainer>
         <ContentContainerOne>
          ...
          <Attachment src={typeof attachment==='object' ? attachment['source_url']: 'https://www.newspitara.com/wp-content/plugins/td-composer/legacy/Newspaper/assets/images/no-thumb/td_696x0.png'} css={css`display:block; width:750px; @media ${device.mobile}{width:95%;height:40vh;margin-top:50px;}`}/>
          <AdsContainer css={css`@media ${device.mobile}{top:20px;display:block;height:auto;}`}>
            <Text>-Advertisement-</Text>
            <AdImage src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz-970-2.jpg'></AdImage>
           <AdImage1 src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz4.png'/>
         </AdsContainer> 
          
            <div css={css`width:780px;margin-top:10px; @media ${device.mobile}{width:90%;margin-top:50px;display:block;height:auto;overflow:hidden;}`}>
             <Html2React html={post.excerpt.rendered} />
            </div>
            <AdsContainer css={css`@media ${device.mobile}{margin-top:0px;height:auto;top:30px;}`}>
                <Text>-Advertisement-</Text>
                <AdImage src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz-970-2.jpg'></AdImage>
                <AdImage1 src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz4.png'/>
           </AdsContainer>
           {post.tags==='object' &&              
           <div css={css`margin-top:10px;margin-left:300px; @media ${device.mobile}{margin-left:0px;margin-top:50px;display:block;}`}>
            ...
            <div css={css`position:relative;top:60px;border:1px solid #E8E8E8;padding:20px;width:700px;height:150px; @media ${device.mobile}{width:90%;height:auto;}`} >
               <div css={css` @media ${device.mobile}{display:block;width:auto;margin-left:24%;}`}>
               ...
               <div css={css`display:inline;position:relative;top:10px; @media ${device.mobile}{position:static;display:block;width:90px;margin-left:24%;}`}>
                  <p css={css`font-weight:bold;font-size:20px; @media ${device.mobile}{margin-left:30px;}`}>{author ? author.name :''}</p>
           ...
           <ContentContainerTwo css={css`@media ${device.mobile}{margin-top:110px;}`}>
             ...
             <RightPost  >
                {typeof posts.items==='object' && posts.items.map((item,i)=>{
                    ...
                    return(<div >
                        {i===1 ?
                                ( <Children key={i} css={css`width:270px;height:310px;overflow:hidden;margin-top:10px; @media ${device.mobile}{width:100%;height:120px;}`} >                                                
                                <Image src={typeof attachment==='object' ? attachment['source_url'] : 'https://www.newspitara.com/wp-content/plugins/td-composer/legacy/Newspaper/assets/images/no-thumb/td_696x0.png'} css={css`width:290px;height: 150px;object-fit: fill;transform: scale(1.4); @media ${device.mobile}{width:30%;height:12vh; float:left;}`}/>
                                    <div css={css`position:relative;top:30px;color:white; @media ${device.mobile}{left:30px;top:0px;width:65%;float:left;}`}>
                                        <p style={{fontSize:'0.7rem',color:'#4169E1'}}>{category.name}</p>
                                        <Link href={post.link+post.id}>
                                            <h1  css={css`color:black;margin-top:5px;font-size:15px;width:20rem;text-transform: capitalize; font-size:10px,&:hover{text-decoration:underline;} @media ${device.mobile}{width:95%;font-weight:500;font-size:15px;}`}>{link}</h1>
                                        </Link>
                                ...
                                :i===2 
                                 ? <>
                                          <ImageContainer css={css`@media ${device.mobile}{left:10%;}`}>
                                           <Advert>- Advertisement -</Advert>
                                           <ImageOne src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz2.png'/>
                                          </ImageContainer>
                                          <Children key={i} style={{}} css={css`width:350px;height:120px;overflow:hidden; @media ${device.mobile}{width:100%;margin-top:10px;}`} >                                                
                                          <Image src={typeof attachment==='object' ? attachment['source_url'] : 'https://www.newspitara.com/wp-content/plugins/td-composer/legacy/Newspaper/assets/images/no-thumb/td_696x0.png'} css={css`width:75px;height: 65px;object-fit:fill;transform:scale(1.4);float:left; @media ${device.mobile}{width:30%;height:12vh;}`}/>
                                          <div css={css`position:relative;float:left;left:20px; @media ${device.mobile}{width:65%;left:30px;}`}>
                                            <p style={{fontSize:'0.6rem',color:'#4169E1'}}>{category.name}</p>
                                            <Link href={post.link+post.id}>
                                              <h1 css={css`color:black;margin-top:5px;font-size:15px;width:20rem;text-transform: capitalize; font-size:10px,&:hover{text-decoration:underline;} @media ${device.mobile}{width:90%;font-weight:500;font-size:15px;}`}>{link}</h1>
                                            </Link>
                                            <p style={{fontSize:'12px',marginTop:'5px',color:'black'}}>{author ? author.name:''}-{new Date(post.date).toLocaleDateString('en-Us',{month:'long',day:'2-digit',year:'numeric'})}</p>
                                          </div>                         
                            </Children>
                                </>:i>2 && i<=4 && (<Children key={i} css={css`width:350px;height:120px;overflow:hidden; @media ${device.mobile}{width:100%;}`} >                                                
                               <Image src={typeof attachment==='object' ? attachment['source_url'] : 'https://www.newspitara.com/wp-content/plugins/td-composer/legacy/Newspaper/assets/images/no-thumb/td_696x0.png'}  css={css`width:75px;height: 65px;object-fit:fill;transform:scale(1.4);float:left; @media ${device.mobile}{width:30%;height:12vh;}`}/>
                                <div css={css`position:relative;float:left;left:20px; @media ${device.mobile}{width:65%;left:30px;}`}>
                                    <p style={{fontSize:'0.6rem',color:'#4169E1'}}>{category.name}</p>
                                    <Link href={post.link+post.id}>
    ...
    <RelatedNews/>
    <AdsContainer css={css`position:relative;top:140px;margin-left:390px; @media ${device.mobile}{margin-left:0px;top:50px;margin-top:20px;height:auto;}`}>
            <Text>-Advertisement-</Text>
            <AdImage src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz-970-2.jpg'></AdImage>
           <AdImage1 src='https://www.newspitara.com/wp-content/uploads/2021/11/corhaz4.png'/>
    </AdsContainer>  
    <div css={css`position:relative;top:200px;left:480px;width:800px; @media ${device.mobile}{top:70px;left:10px;width:95%;}`}>
