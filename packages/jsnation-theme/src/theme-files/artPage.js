...
const ArtPage = ({state,actions}) => {
    ...
    const data=state.source.get('/category/arts');
  ...
  <Container>
      ...
      <Content>
        ...
        <Paragraph style={{backgroundColor:'#4169E1'}}>ARTS</Paragraph>
...
export default connect(ArtPage);
