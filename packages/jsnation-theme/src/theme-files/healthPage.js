...
const HealthPage = ({state,actions}) => {
    ...
    const data=state.source.get('/category/health');
  ...
  <Container>
      ...
      <Content>
        ...
        <Paragraph style={{backgroundColor:'#4169E1'}}>HEALTH</Paragraph>
...
export default connect(HealthPage);
